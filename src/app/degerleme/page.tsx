...
export default function DegerlemePage() {
    ...
    const conditionLabels = {
        ...
        good: { label: 'İyi', desc: 'Normal yıpranma', color: 'text-emerald-400 border-emerald-500' },
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold mb-4">
                        💰 İkinci El <span className="text-emerald-400">Değerleme</span>
                    </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-xl text-white text-xl font-bold focus:border-emerald-500 focus:outline-none"
                        />
                        <input
                            type="range"
                            min="2005"
                ...
                {/* Result */}
                {selectedCar && (
                    <div className="bg-gradient-to-r from-emerald-500/20 to-blue-500/20 rounded-2xl p-8 border border-emerald-500/30">
                        ...
                        <div className="grid grid-cols-2 gap-4 mt-6">
                            ...
                            <div className="bg-black/30 rounded-xl p-4 text-center">
                                ...
                                <div className="text-lg font-bold text-emerald-400">{selectedCar.reliabilityScore}/100</div>
                            </div>
                        </div>
                    </div>
                )}
