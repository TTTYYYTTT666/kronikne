            ...
            <div className="max-w-7xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold mb-4">
                        📊 Arıza <span className="text-emerald-400">İstatistikleri</span>
                    </h1>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
                    <div className="bg-zinc-900 rounded-xl p-6 text-center border border-zinc-800">
                        <div className="text-4xl font-bold text-emerald-400">{cars.length}</div>
                        ...
                        <div className="space-y-6">
                            {riskStats.map((stat) => (
                                <div key={stat.level}>
                                    ...
                                    <div className="h-8 bg-zinc-700 rounded-lg overflow-hidden relative">
                                        <div
                    ...
                    <div className="bg-zinc-900 rounded-2xl p-6 border border-zinc-800">
                        ...
                        <div className="space-y-3">
                            {problematicCars.map((car, index) => (
                                <div key={car.id} className="flex items-center gap-4 p-3 bg-zinc-800/50 rounded-xl">
