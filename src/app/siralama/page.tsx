...
export default function SiralamaPage() {
    ...
    const getScoreColor = (score: number) => {
        ...
        if (score >= 75) return 'text-emerald-400 bg-emerald-500/20';
            ...
            <div className="max-w-5xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold mb-4">
                        🏆 Marka <span className="text-emerald-400">Güvenilirlik Sıralaması</span>
                    </h1>
                ...
                <div className="grid grid-cols-3 gap-4 mb-12">
                    {rankings.slice(0, 3).map((brand, index) => (
                        <div
                            key={brand.brand}
                            className={`bg-zinc-900 rounded-2xl p-6 text-center border ${index === 0 ? 'border-yellow-500/50 order-2' :
                ...
                <div className="bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800">
                    ...
                    <div className="divide-y divide-zinc-800">
                        {rankings.map((brand, index) => (
                            <div key={brand.brand} className="p-4 flex items-center gap-4 hover:bg-zinc-800/50 transition-colors">
