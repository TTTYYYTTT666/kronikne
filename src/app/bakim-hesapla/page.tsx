...
export default function BakimHesaplaPage() {
    ...
    const categories = [...new Set(maintenanceCosts.map(c => c.category))];
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold mb-4">
                        🔧 Bakım Maliyet <span className="text-emerald-400">Hesaplayıcı</span>
                    </h1>
                ...
                {selectedCar && (
                    <>
                        {/* Yearly Estimate */}
                        <div className="bg-gradient-to-r from-emerald-500/20 to-blue-500/20 rounded-2xl p-8 mb-8 border border-emerald-500/30 text-center">
                        ...
                        <div className="bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-800">
                            ...
                            {categories.map(category => (
                                <div key={category}>
                                    <div className="px-6 py-3 bg-zinc-800 text-sm font-semibold text-gray-400">
                                        {category}
                                    </div>
