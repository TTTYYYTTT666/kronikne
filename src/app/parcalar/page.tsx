            ...
            <div className="max-w-6xl mx-auto px-4 py-12">
                ...
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold mb-4">
                        🔩 Yedek Parça <span className="text-emerald-400">Fiyat Karşılaştırması</span>
                    </h1>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            <thead className="bg-zinc-800">
                                <tr>
                                    <th className="px-4 py-4 text-left text-gray-400 sticky left-0 bg-zinc-800">Parça</th>
                                    {brandPricesData.map(brand => (
                                        <th key={brand.brand} className="px-4 py-4 text-center min-w-[140px]">
                                            <div className="flex flex-col items-center gap-2">
                                                <div className="w-10 h-10">
                                                    <BrandLogo brand={brand.brand} />
                                                </div>
                                                <span className={`text-xs px-2 py-1 rounded-full ${segmentColors[brand.segment]}`}>
                            ...
                            <tbody className="divide-y divide-zinc-800">
                                {partsList.map((part) => (
                                    <tr key={part.part} className="hover:bg-zinc-800/50">
                                        <td className="px-4 py-4 sticky left-0 bg-zinc-900">
