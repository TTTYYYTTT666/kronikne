            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-8">
                    <Link
                        ...
                        className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 hover:border-blue-500 transition-colors group"
                    >
                    ...
                    <Link
                        ...
                        className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 hover:border-green-500 transition-colors group"
                    >
                        <div className="text-2xl mb-2">📝</div>
                    ...
                    <Link
                        href="/admin/yorumlar"
                        className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 hover:border-purple-500 transition-colors group"
                    >
                        <div className="text-2xl mb-2">💬</div>
                    ...
                    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                        ...
                        <div className="space-y-3">
                            {stats.recentExperiences.map(exp => (
                                <div key={exp.id} className="p-3 bg-zinc-800/50 rounded-lg">
                ...
                <div className="mt-6 bg-zinc-900 border border-zinc-800 rounded-xl p-6">
                    ...
                    <div className="space-y-3">
                        {stats.recentComments.map(comment => (
                            <div key={comment.id} className="flex items-start justify-between p-3 bg-zinc-800/50 rounded-lg">
